<template>
  <div class="w-1/4 p-6 bg-white rounded-lg shadow-md">
    ...
    <div class="mb-6 text-left">
      <h3 class="text-xl font-semibold text-gray-800">專案相關資訊</h3>
      <hr class="mt-4 border-gray-300" />
      <div class="mt-4 space-y-4">
        ...
        >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            class="px-4 py-2 text-sm font-medium text-blue-600 hover:text-blue-700 bg-white border border-blue-600 rounded-md hover:bg-blue-50 transition-colors duration-200"
          >
            查看
          </a>
        </div>

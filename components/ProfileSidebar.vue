<template>
    <div class="w-1/4 p-6 bg-white rounded-lg shadow-md">
        ...
        <div class="flex justify-center mb-6">
            <img :src="`https://www.gravatar.com/avatar/${gravatarHash}?s=200`" alt="Profile Avatar"
                class="w-48 h-48 rounded-full shadow-lg" />
        </div>

        <!-- Name Section -->
        <div class="text-center mb-2">
            <h2 class="text-2xl font-bold text-gray-800">Mrbandi (解竣翔)</h2>
        </div>

        <!-- Social Links - Horizontal Layout -->
        <div class="flex justify-center space-x-4">
            <!-- GitHub -->
            <a href="https://github.com/Mrbandi" target="_blank" rel="noopener noreferrer"
                class="flex flex-col items-center p-3 rounded-lg transition-colors duration-200">
                <svg class="w-6 h-6 text-gray-700 mb-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
            ...
            <!-- Discord -->
            <a href="https://discord.com/users/mrbandi.dev" target="_blank" rel="noopener noreferrer"
                class="flex flex-col items-center p-3 rounded-lg transition-colors duration-200">
                <svg class="w-6 h-6 text-gray-700 mb-2" viewBox="0 -28.5 256 256" version="1.1"
            ...
            <!-- Instagram -->
            <a href="https://instagram.com/_xiang.0101" target="_blank" rel="noopener noreferrer"
                class="flex flex-col items-center p-3 rounded-lg transition-colors duration-200">
                <svg class="w-6 h-6 text-gray-700 mb-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="mb-6 text-left">
            <h3 class="text-xl font-semibold text-gray-800 ">個人簡介</h3>
        ...
        <div class="mb-6 text-left">
            <h3 class="text-xl font-semibold text-gray-800">經常使用的語言</h3>
            <hr class="mt-4 border-gray-300" />
            <div class="mt-4 grid grid-cols-2 gap-4">
                <!-- Python -->
                <div class="flex items-center space-x-3">
                    <svg class="w-6 h-6" viewBox="0 0 256 255" xmlns="http://www.w3.org/2000/svg"
                ...
                <!-- Lua -->
                <div class="flex items-center space-x-3">
                    <svg class="w-7 h-7" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg">
                        <g>
                            <!-- 主圓圈 -->
                            <path
                ...
                <div class="flex items-center space-x-3">
                    <svg class="w-6 h-6" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path fill="#00DC82"
                            d="M15.095 22.507a2.37 2.37 0 0 1-2.032-1.14l-5.214-9.04a2.37 2.37 0 0 0-2.032-1.14H4.143v10.54H0V2.273h5.817c1.072 0 2.064.57 2.605 1.496l5.214 9.04c.236.408.673.66 1.145.66h1.674V2.274h4.142v18.813h-4.142v-8.12h-1.674c-.472 0-.91.252-1.145.66l-1.432 2.482 2.891 5.008c.236.408.673.66 1.145.66h.435v.73h-1.58z" />
                    </svg>
        ...
        <div class="mb-6 text-left">
            ...
            <div class="mt-4 grid grid-cols-2 gap-4">
                <!-- Next.js -->
                <div class="flex items-center space-x-3">
                    <svg class="w-6 h-6" viewBox="0 0 256 256" version="1.1" xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="mb-6 text-left">
            ...
            <div class="mt-4 grid grid-cols-2 gap-4">
                ...
                <div class="flex items-center space-x-3">
                    <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1"
                        ...
                        <path class="cls-1"
                            ...
                            transform="translate(-7.45 -9.1)"></path>
                        <path class="cls-1"
                ...
                <!-- Docker -->
                <div class="flex items-center space-x-3">
                    <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" aria-label="Docker" role="img" viewBox="0 0 512 512"
                        fill="#000000">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
